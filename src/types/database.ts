...
export type Database = {
  ...
  public: {
      ...
      bookmarks: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "user_bookmarks_with_projects"
      ...
      collection_projects: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["collection_id"]
            isOneToOne: false
            referencedRelation: "public_collections_with_stats"
            referencedColumns: ["id"]
          },
          {
    ...
    Functions: {
      accept_project_invitation: { Args: { p_invitation_id: string }; Returns: Json }
      can_manage_project: {
        Args: { p_project_id: string; p_user_id?: string }
        Returns: boolean
      }
      decline_project_invitation: { Args: { p_invitation_id: string }; Returns: Json }
      get_unique_project_creators_count: { Args: never; Returns: number }
      is_project_member: {
        Args: { p_project_id: string; p_user_id?: string }
        Returns: boolean
      }
      is_valid_illinois_email: { Args: { email: string }; Returns: boolean }
      revoke_project_invitation: { Args: { p_invitation_id: string }; Returns: Json }
      sync_vote_counts: {
        Args: never
        Returns: {
          fixed: boolean
