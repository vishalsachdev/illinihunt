...
export function CategoryPreview({ onSelect }: CategoryPreviewProps) {
  ...
  return (
    <div className="mb-12 sm:mb-16">
      <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-6 text-center">Explore by Category</h3>
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 max-w-4xl mx-auto px-4">
        {categories.map((category) => (
          <button
            ...
            className="group bg-white border border-gray-200 rounded-lg p-3 sm:p-4 hover:border-uiuc-orange/50 hover:shadow-md transition-all duration-300 text-center"
          >
            <div
            ...
            <span className="text-gray-700 text-xs sm:text-sm font-medium group-hover:text-uiuc-orange transition-colors">
              {category.name}
            </span>
          </button>
        ))}
